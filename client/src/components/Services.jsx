...
const Services = () => {
  return (
    <div className='flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services'>
      <div className='flex mf:flex-row flex-col items-center justify-between mdLp-20 py-12 px-4'>
      ...
      <div className='flex-1 flex flex-col justify-start items-center'>
        <ServiceCard 
          ...
          subtitle='Security is guranted. We always maintain privacy and maintain the quality of products.'
        />
        <ServiceCard 
          color='bg-[#8945F8]'
